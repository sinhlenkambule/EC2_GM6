...
# Building out the predication page
	...
	if selected == "Visualisations":
		...
		st.write("""
					...
					* Based on the information/sentiments displayed by our bar graph, we can see that the vast majority lies within the "1"-sentiment (the tweet that supports the belief of man-made climate change).
					* Only a few distribution is shown under the "-1"-sentiment (the tweet that does not supports the belief of man-made climate change)
		...
		st.write("""
					...
					* A vast majority lies within the Prominent sentiment, dominating the chart with 54% contribution.
					* While Anthropogenic sentiment only contributes with 8%.
					* Through the percentages displayed in the pie-chart, we can observe that the majority of people believe in man-made climate change. 
